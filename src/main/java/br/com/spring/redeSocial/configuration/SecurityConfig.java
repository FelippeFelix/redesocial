package br.com.spring.redeSocial.configuration;
...
import br.com.spring.redeSocial.service.serviceImpl.UsuarioServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable().authorizeRequests()
			.antMatchers("/cadastro", "login").not().authenticated()
	...
	// Para quando o Bootstrap usado for baixado, não quando é usado pelo link online
	@Override
